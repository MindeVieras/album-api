...
var _awsKeys = require('../../aws-keys.json');

var _awsKeys2 = _interopRequireDefault(_awsKeys);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var connection = require('../config/db');

var clientSecretKey = _awsKeys2.default.secretAccessKey;
// Set these two values to match your environment
var expectedBucket = _config.bucket;
var expectedHostname = _config.bucket + '.s3.eu-west-1.amazonaws.com';
...
function signV4RestRequest(headersStr) {
  var matches = /.+\n.+\n(\d+)\/(.+)\/s3\/aws4_request\n([\s\S]+)/.exec(headersStr),
      hashedCanonicalRequest = _cryptoJs2.default.SHA256(matches[3]),
...
function getV2SignatureKey(key, stringToSign) {
  var words = _cryptoJs2.default.HmacSHA1(stringToSign, key);
  return _cryptoJs2.default.enc.Base64.stringify(words);
}
...
function getV4SignatureKey(key, dateStamp, regionName, serviceName, stringToSign) {
  var kDate = _cryptoJs2.default.HmacSHA256(dateStamp, "AWS4" + key),
      kRegion = _cryptoJs2.default.HmacSHA256(regionName, kDate),
      kService = _cryptoJs2.default.HmacSHA256(serviceName, kRegion),
      kSigning = _cryptoJs2.default.HmacSHA256("aws4_request", kService);

  return _cryptoJs2.default.HmacSHA256(stringToSign, kSigning).toString();
}
...
function onSuccess(req, res) {
  var _req$body = req.body,
      ...
      key = _req$body.key,
      name = _req$body.name,
      filesize = _req$body.filesize,
      mime = _req$body.mime,
      entity = _req$body.entity,
      entity_id = _req$body.entity_id,
