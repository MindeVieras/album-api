...
const clientSecretKey = 'YQkReaE4y0bYk+yy++AWL/x2yx70iIu6GpJsjFbo'

// Set these two values to match your environment
const expectedBucket = 'mindelistest'
const expectedHostname = 'mindelistest.s3.eu-west-1.amazonaws.com'
...
// Uploader success endpoint
app.post('/upload-ok', function(req, res) {
  console.log(req.body)
