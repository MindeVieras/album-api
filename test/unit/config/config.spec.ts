...
describe('Configuration test.', () => {
  it('config object should return valid config', () => {
    ...
    expect(config.db).to.be.an('object')
    expect(config.db.host).to.be.a('string')
    expect(config.db.user).to.be.a('string')
    expect(config.db.pass).to.be.a('string')
    expect(config.db.name).to.be.a('string')
    expect(config.db.port).to.be.a('number')
