  ...
  async.waterfall(
        ...
        gm(response.Body).size(function(err, size) {
          ...
          var createVersion = function(versions, ind, buffers) {
            ...
            if (versions[ind].crop) {
              self
                .quality(versions[ind].quality)
                .resize(versions[ind].width, versions[ind].height, '^')
                .gravity('Center')
                .crop(versions[ind].width, versions[ind].height)
    ...
    function(err) {
      if (err) {
        ...
        console.log('Successfully resized ' + srcBucket + '/' + srcKey + ' and uploaded to ' + dstBucket + '/' + srcKey)
      }
